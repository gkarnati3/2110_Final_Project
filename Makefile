...
PROGNAME = Fall_Out_Boy_Brick_Breaker
...
OFILES = gba.o font.o logic.o graphics.o main.o images/garbage.o images/title.o images/tryagain.o images/game1.o images/game2.o images/title2.o images/sad.o
